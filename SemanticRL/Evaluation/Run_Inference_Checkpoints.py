...
if __name__ == "__main__":
    ...
    parser.add_argument("--data_root", type=str, default='/home/eric/test/SemanticRL/Europarl')
    parser.add_argument("--epoch_start", type=int, default=90)
    parser.add_argument("--epoch_end", type=int, default=93)
